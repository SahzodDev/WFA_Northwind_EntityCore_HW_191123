...
namespace WFA_Northwind_EntityCore_HW_191123.Contexts
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<ViewCustomerPurchase> ViewCustomerPurchases { get; set; } = null!;
        ...
        public virtual DbSet<VwBestSellerProduct> VwBestSellerProducts { get; set; } = null!;
        public virtual DbSet<VwEmployeeOrder> VwEmployeeOrders { get; set; } = null!;
        public virtual DbSet<VwQuantityPerOrder> VwQuantityPerOrders { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-EVCENE1;Database=Northwind;User Id=sa;Password=Anyela123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ViewCustomerPurchase>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("View_CustomerPurchase");

                entity.Property(e => e.AlışverişTutarı).HasColumnName("Alışveriş Tutarı");

                entity.Property(e => e.MüşteriŞirketi)
                    .HasMaxLength(40)
                    .HasColumnName("Müşteri Şirketi");
            });
            ...
            modelBuilder.Entity<VwBestSellerProduct>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_BestSellerProducts");

                entity.Property(e => e.ProductName).HasMaxLength(40);

                entity.Property(e => e.SatışAdedi).HasColumnName("Satış Adedi");
            });

            modelBuilder.Entity<VwEmployeeOrder>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_EmployeeOrders");
            ...
            modelBuilder.Entity<VwQuantityPerOrder>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_QuantityPerOrders");
